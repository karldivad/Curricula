...
\poster
{
	...
	\end{tabular}\\
	\vspace*{0.7cm}
		\Cblur{\includegraphics[width=0.975\textwidth,height=0.63\textheight]{../fig/big-graph-curricula-<LANG>.ps}} \\
	%\vspace{0.5cm}	
...
% 	\vspace*{-0.7cm}
	...
	\Cblur{\tcbincludegraphics[hbox,colframe=white,boxrule=0pt,arc=0pt,outer arc=0pt,colback=white,graphics options={width=\bigstandard}]{../fig/curves-\currentarea-with-CS-<LANG>.eps}} \\
	\vspace{0.2cm} 
	\color{white}{\captionsize \bf CS (\siglas) vs CS (ACM/IEEE-CS)}\vspace*{0.2cm}   \\
	\hrule \vspace{0.2cm} 	

	\begin{tabular}{cc}
		\Cblur{\tcbincludegraphics[hbox,colframe=white,boxrule=0pt,arc=0pt,outer arc=0pt,colback=white,graphics options={width=\smallstandard}]{../fig/curves-\currentarea-with-CE-<LANG>.eps}} &
        \Cblur{\tcbincludegraphics[hbox,colframe=white,boxrule=0pt,arc=0pt,outer arc=0pt,colback=white,graphics options={width=\smallstandard}]{../fig/curves-\currentarea-with-IS-<LANG>.eps}} \\
	...
	\begin{tabular}{cc}
        \Cblur{\tcbincludegraphics[hbox,colframe=white,boxrule=0pt,arc=0pt,outer arc=0pt,colback=white,graphics options={width=\smallstandard}]{../fig/curves-\currentarea-with-SE-<LANG>.eps}} &
        \Cblur{\tcbincludegraphics[hbox,colframe=white,boxrule=0pt,arc=0pt,outer arc=0pt,colback=white,graphics options={width=\smallstandard}]{../fig/curves-\currentarea-with-IT-<LANG>.eps}} \\
