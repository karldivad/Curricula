...
\begin{outcomes}
    \item \ShowOutcome{a}{3} % Apply computational and math skills appropriate to the discipline. 
    \item \ShowOutcome{b}{3} % Analyze problems and identify and define the appropriate computational requirements for their solution.
    \item \ShowOutcome{h}{2} % Joining a process of continuous professional learning.
    \item \ShowOutcome{i}{2} % Use current techniques and tools necessary for the practice of computing.
\end{outcomes}

\begin{competences}
    \item \ShowCompetence{C1}{a} % Intellectual understanding and the ability to apply mathematical bases and computer science .
    \item \ShowCompetence{C2}{b} % Ability to have a critical and creative perspective to identify and solve problems using computational thinking.
    \item \ShowCompetence{C3}{b} % An intellectual understanding of, and appreciation for, the central role of algorithms and data structures.
    \item \ShowCompetence{C5}{i} % Ability to implement algorithms and data structures in software.
    \item \ShowCompetence{C6}{i} % Ability to design and implement larger structural units that use algorithms and data structures and interfaces through which these units communicate
    \item \ShowCompetence{C9}{a} % Understanding the limitations of computing, including the difference between what computing is inherently unable to cope with what can be achieved through a future of science and technology.
    \item \ShowCompetence{C16}{h} % Ability to identify advanced computing topics and understanding the boundaries of the discipline.
\end{competences}
