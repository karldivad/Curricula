...
\begin{justification}
This is the second course in the sequence of introductory courses in computer science.The course will serve as a bridge between the paradigm of the imperative and the object-oriented, the other will introduce participants in the various topics of the area of computing as: algorithms, data structures, engineering
Software, etc.
\end{justification}

\begin{goals}
\itemIntroduce the student to the foundations of the object orientation paradigm, allowing the assimilation of concepts necessary to develop information systems.
\end{goals}
