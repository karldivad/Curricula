...
\course{CS1701209. Ciencia de la Computación I}{Obligatorio}{CS1701209} % Common.pm

\begin{justification}
This is the second course in the sequence of introductory courses in computer science.The course will serve as a bridge between 
the paradigm of the imperative and the object-oriented, the other will introduce participants in the various topics of 
the area of computing as: algorithms, data structures, Software Engineering, etc.
\end{justification}
