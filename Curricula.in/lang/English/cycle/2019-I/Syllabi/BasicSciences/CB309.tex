...
% Source file: ../Curricula.in/lang/English/cycle/2019-I/Syllabi/BasicSciences/CB309.tex
...
\begin{unit}{Secondary and tertiary structures}{}{Setubal1997,Clote2000,Aluru2006}{4}{CS2}
   \begin{topics}
    ...
    \item \textit{it{Protein folding}: Estructuras en proteinas, problema de protein folding.
    \item \textit{it{Protein Threading}: Definitions, Branch \ Bound Algorithm, Branch \ Bound for protein threading.
    \item \textit{it{Structural Alignment}: Definitions, DALI algorithm
   \end{topics}
   \begin{learningoutcomes}
