...
<<<<<<< HEAD
\course{MA1701101. Razonamiento Lógico Matemático}{Obligatorio}{MA1701101} % Common.pm
=======
\course{MA100. Matemática Básica}{Obligatorio}{MA100} % Common.pm
...
% begin{unit}{Complex number}{Stewart,RonLarson}{0}{3}
   \begin{topics}
    ...
    \item . %`Moivre\textquotesingle theorem
   \end{topics}

   \begin{learningoutcomes}
      \item . %Define and operates with complex numbers, calculating their the polar and exponential form [\Assessment].
      \item . %Use `Moivre\textquotesingle theorem to simplify calculations of complex [\Assessment].
...
% begin{unit}{}{Limits and derivate}{Stewart,RonLarson}{20}{C1}
   \begin{topics}
      ...
      \item . %`L\textquotesingle Hospital theorem 
