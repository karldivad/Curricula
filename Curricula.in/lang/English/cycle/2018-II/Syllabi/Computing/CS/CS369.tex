...
\item Entendimiento a detalle del principio, fundamentos teóricos, funcionamiento, implementación, intepretación de resultados y operación de los algoritmos de la Computación Evolutiva más populares y utilizados por la comunidad cientTecnologíafica y profesional.
...
\begin{topics}
        ...
        \item HeurTecnologíasticas: definición, {\it Tabu search}, {\it Hill Climbing} {\it Simulated Annealing}, {\it Evolutionary Algorithms}
\end{topics}	
\begin{unitgoals}
  ...
  \item Entender e implementar algoritmos básicos de Optimización aplicados a problemas {\it benchmark}. 
	\item Entender la necesidad de uso de heurTecnologíasticas
\end{unitgoals}
\end{unit}
...
\begin{topics}
   ...
   \item Algoritmo Genético Canónico: procedimiento elemental, ciclo de un AG, representación (codificación binaria, real a binario, decodificación binario a real), inicialización de la población, evaluación y aptitud, selección (proporcional, torneo), operadores genéticos (cruces, mutaciones), el dilema {\it exploiting-exploring}, ajustes en la aptitud, ajustes en la selección.
	 ...
	 \item Convergencia
   \item TeorTecnologíaa de {\it Schemata}: Máscaras, esquemas, definiciones y propiedades, {\it Schemata theorem}: impacto de la selección, cruce de 1 punto y mutación, teorema fundamental de los algoritmos genéticos, hipótesis de los bloques constructores.
\end{topics}
\begin{unitgoals}
...
\begin{topics}
  ...
  \item Algoritmos Evolutivos de orden: representación de soluciones, operadores de orden: cruces, mutaciones
	...
	\item Problemas de Planificación: variables tTecnologíapicas, caracterTecnologíasticas, representación, codificadores, evaluación de una planificación. 
\end{topics}
\begin{unitgoals}
...
\begin{topics}
  \item PEA -- Algoritmos Evolutivos en Paralelo: arquitecturas de paralelización, arquitecturas {\it master-slave}, {\it coarse-grained}, {\it fine-grained} e hTecnologíabridas 
...
\begin{topics}
      \item HEA -- Algoritmos Evolutivos HTecnologíabridos: Por qué hibridizar?, formas de hibridización, búsqueda local y aprendizaje.
      ...
      \item CoEv -- Coevolución: caracterTecnologíasticas, modelo competitivo, modelo cooperativo.
