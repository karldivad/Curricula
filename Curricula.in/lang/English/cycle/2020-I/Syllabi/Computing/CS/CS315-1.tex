...
\begin{unit}{Técnicas Básicas de Implementación de Estructuras de Datos}{Cuadros2004Implementing,Knuth2007TAOCP-V-I,Knuth2007TAOCP-V-II,Gamma94}{16}{j}
   \begin{topics}
...
\begin{unit}{Métodos de Acceso Multidimensionales}{Gaede98multidimensional}{16}{j}
   \begin{topics}
...
\begin{unit}{Métodos de Acceso Métrico}{Chavez:01,Traina00SlimTree,Zezula07}{20}{j}
   \begin{topics}
...
\begin{unit}{Métodos de Acceso Aproximados}{Indyk06,Zezula07}{20}{j}
   \begin{topics}
...
\begin{unit}{Seminarios}{Chavez:01}{8}{a,b,j}
	\begin{topics}
