...
\DefineSpecificOutcome{f}{1}{Transmitir de forma clara y en Inglés ideas y propuestas técnicas a audiencias de otras áreas.\xspace}
\DefineSpecificOutcome{f}{2}{Presentar un plan de negocio a potenciales inversionistas.\xspace}
...
\DefineSpecificOutcome{i}{1}{Desarrollar componentes que haciendo uso de técnicas modernas de computación implementen funcionalidad que sean de utilidad para diversos sistemas de informacion.\xspace}
\DefineSpecificOutcome{i}{2}{Utilizacion lenguajes y entornos de programación que permitan la implementacion y depuración de las soluciones.\xspace}
...
%\DefineSpecificOutcome{i}{1}{.\xspace}
...
\DefineSpecificOutcome{m}{1}{Crear una empresa de base tecnológica en el pais y a nivel internacional.\xspace}
