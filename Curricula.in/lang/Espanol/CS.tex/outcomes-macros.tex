...
% CS1D01, 
\DefineSpecificOutcome{a}{1}{Aplicar tecnica de demostracion matematica para la validacion de problemas.\xspace}
% Discretas
\DefineSpecificOutcome{a}{2}{Usar de manera ordenada proposiciones lógicas.\xspace}
% Discretas
\DefineSpecificOutcome{a}{3}{Aplicar de técnicas de conteo en resolución de problemas computacionales.\xspace}
