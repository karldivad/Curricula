...
El Capí­tulo \ref{chap:BOK}, muestra las áreas de Conocimiento de la Ciencia de la Computación, 
...
En el Capí­tulo \ref{chap:laboratories} se presenta una sugerencia de los laboratorios 
requeridos para el dictado de clases las mismas que podrí­an variar de acuerdo al volumen de alumnos que se tenga.

\OnlySPC{   En el Capí­tulo~\ref{chap:professors-and-courses} podemos observar un listado de cursos por profesor y de profesor por curso}
\OnlyMINEDU{En el Capí­tulo~\ref{chap:professors-and-courses} podemos observar un listado de cursos por profesor y de profesor por curso}

\OnlySPC{   En el Capí­tulo~\ref{sec:specific-outcomes-by-course} se puede observar un listado de cursos por cada resultado específico.}
\OnlyMINEDU{En el Capí­tulo~\ref{sec:specific-outcomes-by-course} se puede observar un listado de cursos por cada resultado específico.}
