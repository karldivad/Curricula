...
Por otro lado, en las definiciones en internet de la carrera de Ingenieríade Sistemas en nuestro país está definida como \footnote{La
...
\textit{El Ingeniero de Sistemas es el profesional capaz de analizar, diseñar, investigar, desarrollar y administrar todo tipo de sistemas, aplicando las ciencias básicas, las tecnologTecnologíaas de la información y comunicaciones, y la Teoría General de Sistemas.
...
\begin{itemize}
    ...
    \item Docencia e Investigación. o Asesoría y ConsultorTecnologíaa.
\end{itemize}
}
