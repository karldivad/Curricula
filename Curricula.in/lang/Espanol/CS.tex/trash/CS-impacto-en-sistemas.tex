\section{Impacto sobre la carrera de Ingenieríade Sistemas}\label{sec:impacto-en-sistemas}
Como ya fue explicado en secciones anteriores, el foco es formar
profesionales orientados a generar nueva tecnologTecnologíaa computacional.
Este profesional está muy ligado a la investigación y tiene la
computación \underline{como un fin} en si misma.

Por otro lado, en las definiciones en internet de la carrera de Ingenieríade Sistemas en nuestro paTecnologías está definida como \footnote{La
dirección es http://www.unsa.edu.pe/ y luego se entra a los enlaces:
Área académica->Estudios Pre-Grado->Ingeniería s->Ing. de Sistemas}:

{\it El Ingeniero de Sistemas es el profesional capaz de analizar, diseñar, investigar, desarrollar y administrar todo tipo de sistemas, aplicando las ciencias básicas, las tecnologTecnologíaas de la información y comunicaciones, y la TeorTecnologíaa General de Sistemas.

Fundamentalmente, es capaz de integrar y optimizar los recursos organizacionales para la adecuada toma de decisiones, además de especificar y desarrollar software base y de aplicación generando tecnologTecnologíaa nacional.}
...
\begin{itemize}
    ...
    \item Analizar, diseñar, desarrollar e implementar software especTecnologíafico.
    ...
    \item Docencia e Investigación. o AsesorTecnologíaa y ConsultorTecnologíaa.
\end{itemize}
}

En el texto anterior, se puede observar que la orientación de la carrera de Ingenieríade Sistemas desea utilizar a la computación \underline{como un medio} para mejorar el desempeño de las organizaciones. El objetivo del Ingeniero de Sistemas peruano es el de \underline{aplicar} y llevar la tecnologTecnologíaa computacional a las empresas.
...
orientarTecnologíaa al área de Sistemas de Información, ambas carreras serán
...
de base tecnológica, generar tecnologTecnologíaa de punta y expandir las
...
orientado a llevar y aplicar esa tecnologTecnologíaa al entorno organizacional. Este profesional está orientado al uso de
