 		...
 		\begin{tabular}{m{<TITLE_WIDTH>}}
		      ...
		      \begin{tabular}{m{<DEF_WIDTH>}m{2cm}m{<DEF_WIDTH>}}
			    \begin{minipage}{<DEF_WIDTH>}
				    ...
				    \Cblur{
					    \begin{minipage}{\textwidth}
						    {\bf \large Identidad: } {\footnotesize \mission}
					    \end{minipage}
				    }
			    \end{minipage} & & 
			    \vspace{1cm}
			    \begin{minipage}{<DEF_WIDTH>}
				    \Cblur{
					    \begin{minipage}{\textwidth}
						    {\bf \large Definición:} {\footnotesize \profile}
					    \end{minipage}%
					  }
			    \end{minipage}
		      \end{tabular}
...
%               \vspace*{-10.5cm}
			...
			{\large Definición de Objetivos de Aprendizaje ({\it Learning Outcomes})} 				\\ \hline
			\vspace{0.5cm}
