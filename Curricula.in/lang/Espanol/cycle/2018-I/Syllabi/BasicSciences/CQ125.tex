...
\item Manipulará con destreza los implementos básicos de un laboratorio de qu­mica y obtendrá datos adecuados en la observación de un proceso experimental. 
\item Aplicará normas de seguridad establecidas para la manipulación de sustancias qu­micas y procedimientos básicos de laboratorio.
...
\item Elaborará reportes escritos de las observaciones realizadas, de los datos registrados y de los resultados obtenidos; y, tendrá una actitud cr­tica frente al procedimiento realizado para poder proponer posibles fuentes de error y sugerencias para mejorarlo. 
...
\begin{unit}{Cap­tulo 1: Identificación de sustancias usando procedimientos f­sicos y qu­micos (10 horas)}{}{}{4}{C20}

Conceptuales

\begin{topics}
      \item Identifica y diferencia cambios f­sicos y cambios qu­micos.
      \item Identifica los tipos y componentes de una mezcla
      \item Escribe e interpreta una ecuación qu­mica.
      \item Interpreta los resultados experimentales obtenidos en base a la teor­a.
   \end{topics}
...
\begin{topics}
      ...
      \item Sigue pautas establecidas para el trabajo cient­fico y el desempeño en el laboratorio.
   \end{topics}
...
\begin{unit}{Cap­tulo 2: Configuración electrónica y Propiedades periódicas (10 horas)}{}{}{4}{C20}
...
\begin{topics}
      \item Sigue pautas establecidas para el trabajo cient­fico y el desempeño en el laboratorio.
      \item Manipula sustancias qu­micas y materiales aplicando las normas correspondientes de seguridad en el laboratorio.
...
\begin{unit}{Cap­tulo 3: Experimentando con gases)}{}{}{4}{C20}

Conceptuales

\begin{topics}
      \item Explica el comportamiento gaseoso aplicando las leyes de Boyle y Charles.
      \item Explica algunas propiedades qu­micas del $CO_2$(g).
   \end{topics}
...
\begin{unit}{Cap­tulo 4: Un problema de seguridad industrial: reacciones REDOX y el método del ion - electrón}{}{}{6}{C20}
...
\begin{topics}
      \item Aplica el método del ión-electrón para realizar el balance de las reacciones de óxido-reducción ensayadas, as­ como de los ejercicios que se les proponga.
      \item Elabora un reporte escrito de la experiencia, siguiendo formato establecido.
   \end{topics}
...
\begin{unit}{Cap­tulo 5:  Estequiometr­a: Titulación REDOX}{}{}{4}{C20}
...
\begin{unit}{Cap­tulo 5:  Calorimetr­a a presión constante: determinación del calor de neutralización.}{}{}{4}{C20}
...
\begin{topics}
      \item Determina el calor de neutralización de ácidos fuertes con bases fuertes, realizando mediciones y aplicando relaciones calorimétricas a presión constante, as­ como el concepto de reactivo limitante.
...
%2009	Qu­mica, la ciencia central. 11.a ed. México: Pearson Educación.
%BROWN, L.; HOLME T.
%2015	Chemistry for Engineering Students, 3rd edition, Brooks/Cole-Cengage Learning.
%CHANG, R.
%2010	Qu­mica. 10.a ed. México: Mc Graw-Hill.
...
%ZUMDAHL, S.
%2007	Fundamentos de Qu­mica, 5a edición. McGraw-Hill.
