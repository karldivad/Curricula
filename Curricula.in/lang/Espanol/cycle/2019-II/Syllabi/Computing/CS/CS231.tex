...
% Source file: ../Curricula.in/lang/Espanol/cycle/2019-II/Syllabi/Computing/CS/CS231.tex
...
\begin{topics}%
    ...
    \item Políticas de asignación de recursos del Internet
    \item Direccionamiento IPv4 e IPv6
    \item Diagnosticar problemas en las redes IPs
\end{topics}
\begin{learningoutcomes}
	\item \NCResourceAllocationLODescribeHowBe [\Familiarity]
	\item \NCResourceAllocationLODescribeTheInNetwork [\Familiarity]
    \item Describir los principales problemas del agotamiento de direcciones IPs [\Assessment]
