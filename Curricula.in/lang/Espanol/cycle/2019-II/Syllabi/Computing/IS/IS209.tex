...
\begin{justification}
	...
	\begin{unit}{\LUONEOHDef}{}{\LUONEOHBib}{6}{1}
	   \begin{topics}
	...
	\begin{unit}{\LUONETHREEDef}{}{\LUONETHREEBib}{6}{1}
	   \begin{topics}
		\item \ITONETopicONExONExONE
		\begin{subtopics}
			\item \ITONETopicONExONExONExTHREE
	...
	\begin{unit}{\LUONEFOURDef}{}{\LUONEFOURBib}{6}{1}
	   \begin{topics}
	...
	\begin{unit}{\LUONETHREEDef}{}{\LUONETHREEBib}{4}{1}
	   \begin{topics}
		\item \OMCTHREETopicTWOxTHREExFIVE
	...
	\begin{unit}{\LUONEFOURDef}{}{\LUONEFOURBib}{4}{1}
	   \begin{topics}
	...
	\begin{unit}{\LUONESIXDef}{}{\LUONESIXBib}{8}{1}
	   \begin{topics}
		\item \ITONETopicONExONExONE
		\begin{subtopics}
	...
	\begin{unit}{\LUONEEIGHTDef}{}{\LUONEEIGHTBib}{4}{1}
	   \begin{topics}
