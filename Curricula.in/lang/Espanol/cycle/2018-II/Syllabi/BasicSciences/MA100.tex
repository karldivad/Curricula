...
\course{MA100. Matemáca Bááá}{Obligatorio}{MA100} % Common.pm
...
\begin{unit}{Números complejos}{}{Stewart,RonLarson}{20}{C1}
   ...
   \begin{learningoutcomes}
      ...
      \item . % Utilizar el teorema de Moivre \textquotesingle para simplificar los cáulos de complejos[\Assessment].
