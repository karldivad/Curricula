...
\begin{justification}
El estudio del hombre es importante para responder a las preguntas acerca de quién soy y para qué estoy en el mundo. Las respuestas que se den a dichas preguntas resultan fundamentales, pues de ellas dependerá mucho de la orientación que cada uno dé a su vida tanto en la dimensión personal como en la social. La aproximación al hombre desde la razón necesita la complementariedad de la fe, que le abre un horizonte de mayor comprensión de la verdad. La revelación necesita de la razón para ser aprehendida, comprendida y aplicada. Por lo tanto, el curso de antropologTecnologíaa filosófica y teológica, desde la sTecnologíantesis entre fe y razón, busca dar una respuesta integral acerca de quién es el hombre y para qué está en el mundo, considerando la unidad entre la filosofTecnologíaa y la teologTecnologíaa -fundada en la armonTecnologíaa entre fe y razón- y respetando la distinción entre ambas disciplinas.
\end{justification}
...
\ShowOutcome{FH}{2}
\ShowOutcome{HU}{3}
\ShowOutcome{TASDSH}{3}
\end{outcomes}

\begin{unit}{Quién es el ser humano?}{GarciaCuadrado,JuanPabloA,Edith,Amengual,ReydeCastro,Lepp63}{6}{2}
\begin{topics}
 		\item Qué es una \"antropologTecnologíaa filosófica y teológica\"?
 		\item ArmonTecnologíaa entre fe y razón.
...
\begin{learningoutcomes}
	\item Presentar la AntropologTecnologíaa Filosófica y Teológica desde una aproximación existencial que considera la distinción entre filosofTecnologíaa y teologTecnologíaa, asTecnología como el vTecnologíanculo entre ambas que nace en la armonTecnologíaa de la fe con la razón.
