...
\course{CB101. Ãlgebra y GeometrÃ­a}{Obligatorio}{CB101}
...
\item Relacionar el álgebra con la geometrÃ­a, de modo que visualice problemas que de otro modo serÃ­an abstractos.
\end{goals}
...
\begin{unit}{Sistemas de ecuaciones. Matrices y determinantes}{Strang03,Grossman96}{24}{3}
   ...
   \begin{learningoutcomes}
      ...
      \item Identificar y manipular los diferentes tipos de matrices, asÃ­ como el álgebra de matrices
