...
\begin{unit}{}{Primera Unidad: Estatuto científico de la antropologTecnologíaa filosófica}{GarciaCuadrado}{5}{C20}
\begin{topics}
	\item Presentación del curso
	\item La pregunta sobre el hombre y la importancia de la AntropologTecnologíaa
	\item AntropologTecnologíaa filosófica y antropologTecnologíaas positivas. Delimitando el objeto: 
	\begin{subtopics}
		\item AntropologTecnologíaa fTecnologíasica o natural (etnografTecnologíaa  paleo antropologTecnologíaa)
		\item AntropologTecnologíaa cultural o social (etnologTecnologíaa)
		\item PsicologTecnologíaa Moderna
		\item Limitaciones de la ciencia moderna y el mito del progreso
		\item AntropologTecnologíaa filosófica: Objeto y definición
		\item AntropologTecnologíaa teológica: Objeto y definición
		\item AntropologTecnologíaa teológica: Objeto y definición	
	\end{subtopics}
	\item Planos metodológicos del estudio de la antropologTecnologíaa filosófica. 
\end{topics}

\begin{learningoutcomes}
	\item Comprender la importancia del curso para la formación universitaria (personal y profesional).
Delimitar y definir la AntropologTecnologíaa Filosófica y Teológica y sus respectivos objetos de estudio.
...
\begin{topics}
	\item La jerarquTecnologíaa del mundo natural 
		\begin{subtopics} 
...
\end{topics}
\begin{learningoutcomes}
	\item Analizar y comprender la naturaleza humana utilizando una metodologTecnologíaa ascendente: Comprendiendo el fenómeno de la vida, las semejanzas y diferencias que tenemos con los vivientes (facultades) y las facultades superiores que nos otorgan nuestra diferencia especTecnologíafica en el mundo natural. [\Usage]
\end{learningoutcomes}
\end{unit}
...
\end{topics}
\begin{learningoutcomes}
	\item Presentar la antropologTecnologíaa desde una perspectiva fenomenológica existencial. 
Analizar el aporte de dicho enfoque frente a los vistos anteriormente y frente el hombre moderno. [\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{}{Quinta Unidad: Destino de la Persona Humana - AntropologTecnologíaa Teológica}{GarciaCuadrado}{3}{C20,C21}
\begin{topics}
 	 ...
 	 \item Aproximación existencial y fenomenológica desde la experiencia de finitud:
		...
		\end{subtopics}	
 	 \item AntropologTecnologíaa Teológica:
 	 	\begin{subtopics}
