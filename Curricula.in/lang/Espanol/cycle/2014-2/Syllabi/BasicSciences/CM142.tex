...
\begin{topics}
   ...
   \begin{unitgoals}
      \item Conocer las caracterÃ­sticas de las matrices y el cálculo de determinantes
...
\begin{topics}
      ...
      \item Transformaciones lineales de $R^n$ a $R^n$, de $R^n$ a $R^m$; geometrÃ­a de la transformación lineal de $R^2$ a $R^2$.
