...
\begin{justification}
Este curso es importante porque desarrolla tópicos del Ãlgebra Lineal y de Ecuaciones Diferenciales Ordinarias útiles en todas aquellas áreas de la ciencia de la computación donde se trabaja con sistemas lineales y sistemas dinámicos.
\end{justification}

\begin{goals}
\item Que el alumno tenga la base matemática para el modelamiento de sistemas lineales y sistemas dinámicos necesarios en el Ã rea de ComputaciÃ²n GrÃ fica e Inteligencia Artificial.
\end{goals}
