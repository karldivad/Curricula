...
% Source file: ../Curricula.in/lang/Espanol/cycle/2021-I/Syllabi/Enterpreneurship/ET201.tex
...
%%%%%%%%%%%%%%%%%%%%%%%%%
%%
%% \begin{unit}{TTecnologíatuloUnidad}{}{Bibliografia1,Bibliografia2}{#horas}{Competencia}
%%   \begin{topics}
%%     \item Topico1
%%	   \item Topico2
%%   \end{topics}
