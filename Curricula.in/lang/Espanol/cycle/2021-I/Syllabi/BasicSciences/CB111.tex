...
\course{CB111. Física I}{Obligatorio}{CB111}
...
\begin{unit}{Trabajo, Energía y Potencia}{}{Burbano,ResnikHalliday,SerwayJewett,TriplerMosca}{6}{C1}
\begin{topics}
...
\begin{unit}{}{Cinemática}{Burbano,ResnikHalliday,SerwayJewett,TriplerMosca}{6}{C20}
\begin{topics}
...
\begin{unit}{Las tres leyes de Newton}{Las tres leyes de Newton}{Burbano,ResnikHalliday,SerwayJewett,TriplerMosca}{6}{C24}
\begin{topics}
