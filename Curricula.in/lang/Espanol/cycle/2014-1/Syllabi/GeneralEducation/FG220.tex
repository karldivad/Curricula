...
\begin{unit}{OrÃ­genes de la peruanidad y la formación de la conciencia nacional}{VAB1965,Busto,Morande,Messori96,Estenos}{15}{6}
\begin{topics}
	\item Aproximaciones crÃ­ticas a la realidad peruana: VÃ­ctor Andrés Belaúnde, José Carlos Mariátegui, VÃ­ctor Raúl Haya de la Torre.
	...
	\item Conquista española. Â¿Encuentro o choque de las culturas? Hacia una comprensión integral del fenómeno. Debate conceptual. 
...
\end{topics}
\begin{unitgoals}
	\item Comprender adecuadamente el proceso histórico que determina el nacimiento de nuestra identidad nacional a partir de la sÃ­ntesis cultural del virreinato.
\end{unitgoals}
\end{unit}
...
\begin{unit}{El Perú en la actualidad: análisis del sector polÃ­tico, social y económico}{Contreras2002,Estenos1,Estenos2,BenedictoXVI}{9}{6}
\begin{topics}
	\item Análisis del sistema polÃ­tico peruano.
...
\end{topics}
\begin{unitgoals}
	\item Conocer y analizar la situación actual de la polÃ­tica, económica y social en el Perú, su problemática y posibilidades de solución.
\end{unitgoals}
\end{unit}
