...
\end{topics}
\begin{unitgoals}
	\item Señalar caracterÃ­sticas básicas de la Edad Media y de la Literatura Medieval.
...
\begin{topics}
	\item Gabriel GarcÃ­a Márquez ``Cien años de Soledad''
