...
\course{CS212. Análisis y Diseño de Algoritmos}{Obligatorio}{CS212}
...
\begin{outcomes}
    \item \ShowOutcome{a}{3} % Aplicar conocimientos de computación y de matemáticas apropiadas para la disciplina. 
    \item \ShowOutcome{b}{3} % Analizar problemas e identificar y definir los requerimientos computacionales apropiados para su solución.
    \item \ShowOutcome{h}{2} % Incorporarse a un proceso de aprendizaje profesional continuo.
    \item \ShowOutcome{i}{2} % Utilizar técnicas y herramientas actuales necesarias para la práctica de la computación.
\end{outcomes}

\begin{competences}
    \item \ShowCompetence{C1}{a} % La comprensión intelectual y la capacidad de aplicar las bases matemáticas y la teoría de la informática (computer science).
    \item \ShowCompetence{C2}{b} % Capacidad para tener una perspectiva crítica y creativa para identificar y resolver problemas utilizando el pensamiento computacional.
    \item \ShowCompetence{C3}{b} % Una comprensión intelectual de, y el aprecio por el papel central de los algoritmos y estructuras de datos.
    \item \ShowCompetence{C5}{i} % Capacidad para implementar algoritmos y estructuras de datos en el software.
    \item \ShowCompetence{C6}{i} % Capacidad para diseñar y poner en práctica las unidades estructurales mayores que utilizan algoritmos y estructuras de datos y las interfaces a través del cual estas unidades se comunican.
    \item \ShowCompetence{C9}{a} % Comprensión de las limitaciones de la computación, incluyendo la diferencia entre lo que la computación es inherentemente incapaz de hacer frente a lo que puede lograrse a través de un futuro de ciencia y tecnología.
    \item \ShowCompetence{C16}{h} % Capacidad para identificar temas avanzados de computación y de la comprensión de las fronteras de la disciplina.
\end{competences}
