...
\begin{justification}
Los tÃ³picos de este curso extienden las ideas del diseÃ±o y desarrollo de software desde la secuencia de introducciÃ³n
a la programaciÃ³n para abarcar los problemas encontrados en proyectos de gran escala. Es una visiÃ³n m Ìas amplia y
completa de la IngenierÃ­a de Software apreciada desde un punto de vista de Proyectos.
\end{justification}
...
\begin{goals}
    ...
    \item Familiarizar a los alumnos con el proceso de administraciÃ³n de un proyecto de software de tal manera que sea capaz de crear, mejorar y utilizar herramientas y m Ìetricas que le permitan realizar la estimaciÃ³n y seguimiento de un proyecto de software.
    \item Crear , evaluar e implementar un plan de prueba para segmentos de cÃ³digo de tamaÃ±o medio , Distinguir entre los diferentes tipos de pruebas , sentar las bases para crear, mejorar los procedimientos de prueba y las herramientas utilizadas con ese propÃ³sito.
    \item Seleccionar con justificaciÃ³n un apropiado conjunto de herramientas para soportar el desarrollo de un rango de productos de software.
    \item Crear , mejorar y utilizar los patrones existentes para el mantenimiento de software . Dar a conocer las caracterÃ­sticas y patrones de diseÃ±o para la reutilizaciÃ³n de software.
    \item Identificar y discutir diferentes sistemas especializados , crear , mejorar y utilizar los patrones especializados para el diseÃ±o, implementaciÃ³n , mantenimiento y prueba de sistemas especializados.
\end{goals}
