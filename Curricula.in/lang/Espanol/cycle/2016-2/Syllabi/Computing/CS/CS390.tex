...
a la programación para abarcar los problemas encontrados en proyectos de gran escala. Es una visión m Ìas amplia y
...
\begin{goals}
    ...
    \item Familiarizar a los alumnos con el proceso de administración de un proyecto de software de tal manera que sea capaz de crear, mejorar y utilizar herramientas y m Ìetricas que le permitan realizar la estimación y seguimiento de un proyecto de software.
    ...
    \item Crear , mejorar y utilizar los patrones existentes para el mantenimiento de software . Dar a conocer las caracterÃ­sticas y patrones de diseño para la reutilización de software.
