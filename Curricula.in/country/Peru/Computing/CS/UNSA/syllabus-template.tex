...
\textbf{Objetivos EspecTecnologíaficos} & \textbf{Contenidos} & \textbf{Horas} & \textbf{Fecha} & \textbf{Avance \%} \\ \hline
--UNIT_GOAL-- &
--UNIT_CONTENT--
--CITATIONS-- &
&
...
%\begin{description}
%\item[Examen Parcial] CapTecnologíatulos 1,2,3
%\item[Examen Final] Todos los capTecnologíatulos
%\end{description}
...
\item Libro(s) de la bibliografTecnologíaa
\end{itemize}

\addtocounter{SyllabiSectionCount}{1}
{\bf \arabic{SyllabiSectionCount} MetodologTecnologíaa}
\begin{itemize}
