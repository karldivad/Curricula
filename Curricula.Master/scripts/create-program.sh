...
echo "mkdir -p ../Curricula.in/country/$country/$discipline/$area/$institution"
mkdir -p ../Curricula.in/country/$country/$discipline/$area/$institution
echo "cp ../Curricula.in/country/$countryBase/$disciplineBase/$areaBase/$institutionBase/institution-info.tex ../Curricula.in/country/$country/$discipline/$area/$institution/institution-info.tex"
...
#echo "mkdir -p ../Curricula.in/institution/$country/$institution"
