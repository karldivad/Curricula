...
{
	my ($text) = (@_);
	$text =~ s/\\'A/�/g;		$text =~ s/\\'a/�/g;		$text =~ s/\\'\{a\}/�/g;
	$text =~ s/\\'E/�/g;		$text =~ s/\\'e/�/g;		$text =~ s/\\'\{e\}/�/g;
	$text =~ s/\\'I/�/g;		$text =~ s/\\'i/�/g;		$text =~ s/\\'\{i\}/�/g;
	$text =~ s/\\'O/�/g;		$text =~ s/\\'o/�/g;		$text =~ s/\\'\{o\}/�/g;
	$text =~ s/\\'U/�/g;		$text =~ s/\\'u/�/g;		$text =~ s/\\'\{u\}/�/g;
	$text =~ s/\\~N/�/g;		$text =~ s/\\~n/�/g;		$text =~ s/\\~\{n\}/�/g;
	return $text;
}
...
{
	my ($text) = (@_);
	$text =~ s/�/A/g;		$text =~ s/�/a/g;
	$text =~ s/�/E/g;		$text =~ s/�/e/g;
	$text =~ s/�/I/g;		$text =~ s/�/i/g;
	$text =~ s/�/O/g;		$text =~ s/�/o/g;
	$text =~ s/�/U/g;		$text =~ s/�/u/g;
	$text =~ s/�/N/g;		$text =~ s/�/n/g;
	return $text;
}
...
{
	my ($text) = (@_);
	$text =~ s/�/&Aacute;/g;		$text =~ s/�/&aacute;/g;
	$text =~ s/�/&Eacute;/g;		$text =~ s/�/&eacute;/g;
	$text =~ s/�/&Iacute;/g;		$text =~ s/�/&iacute;/g;
	$text =~ s/�/&Oacute;/g;		$text =~ s/�/&oacute;/g;
	$text =~ s/�/&Uacute;/g;		$text =~ s/�/&uacute;/g;
	$text =~ s/�/&Ntilde;/g;		$text =~ s/�/&ntilde;/g;
	return $text;
}
...
# 			$area_priority{$codcour}		= $axes;
			...
			$course_info{$codcour}{full_prerequisites}	= []; # # CS101F. Name1 (1st Sem, P�g 56), CS101O. Name2 (2nd Sem, P�g 87), ...
